...
<div class="panel-heading"><div class="panel-title">Editar Categoria</div></div>
<div class="panel-body">
<form class="form-group" action="usuarios?op=e">
	<label>Nombre de categoria:</label>
	<input type="text" name="nombre" placeholder="Nombre de Categoria" required="required" class="form-control" value="Armarios">
	<br>
	<label>Descripcion:</label>
	<input type="text" name="desc" placeholder="Descripcion" required="required" class="form-control" value="En este apartado va la descripcion.">
	<br>
