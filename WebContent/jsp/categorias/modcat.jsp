...
<div class="panel-heading"><div class="panel-title">Listado General Categorias</div></div>
...
<tr>
	<td>Armarios</td>
	<td>Este apartado es para la descripcion.</td>
	<td><a href="#"><img src="../../images/editar.png" onclick="reenviar('../../Usuarios?op=ec');" data-toggle="modal" data-target="#myModal"></a></td>
