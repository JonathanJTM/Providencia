...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="/Providencia/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="/Providencia/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="/Providencia/css/bootstrap.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="/Providencia/css/owl.carousel.min.css">
	<link rel="stylesheet" href="/Providencia/css/owl.theme.default.min.css">
	<!-- Theme style  -->
	<link rel="stylesheet" href="/Providencia/css/style.css">
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo">
				<a href="index.html"><img src="/Providencia/images/Logo1.png"></a>
			</h1>
				...
				<div class="fh5co-narrow-content">
		            ...
		            <div class="item">
		            	<figure>
		              	...
		              	<p class="text-center quote">&ldquo;Reseña del negocio &rdquo; <cite class="author">&mdash; ...Autor....</cite></p>
		            </div>
		            <div class="item">
		            	<figure>
		            		<img src="images/testimonial_person3.jpg" alt="Free HTML5 Bootstrap Template">
		            	</figure>
		              	<p class="text-center quote">&ldquo;Reseña de negocio Porque escoger a Carpinteria La Providencia &rdquo;<cite class="author">&mdash; ...Autor....</cite></p>
		            </div>
		            <div class="item">
		            	<figure>
		            		<img src="images/testimonial_person4.jpg" alt="Free HTML5 Bootstrap Template">
		            	</figure>
		              	<p class="text-center quote">&ldquo; Reseña 3 del negocio &rdquo;<cite class="author">&mdash; ....Autor...</cite></p>
		            </div>
		          </div>
				</div>
			</div>
				...
				<div class="fh5co-narrow-content animate-box">
					<div class="row" >
						<div class="col-md-4 text-center">
							<span class="fh5co-counter js-counter" data-from="0" data-to="675" data-speed="5000" data-refresh-interval="50"></span>
							<span class="fh5co-counter-label">Clientes con los que se han trabajado</span>
						</div>
						<div class="col-md-4 text-center">
							<span class="fh5co-counter js-counter" data-from="0" data-to="1850" data-speed="5000" data-refresh-interval="50"></span>
							<span class="fh5co-counter-label">Pedidos Completados</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="fh5co-cards">
				<div class="fh5co-narrow-content">
					...
					<div class="fh5co-flex-wrap">
						...
						<div class="fh5co-card animate-box" data-animate-effect="fadeInLeft">
							<h5>Cumunica tu pedido a la medida</h5>
