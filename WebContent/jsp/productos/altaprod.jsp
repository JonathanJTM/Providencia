...
<form class="form-group" action="usuarios?op=e">
	...
	<input type="text" name="nombre" placeholder="Nombre de Producto" required="required" class="form-control" value="">
	<br>
	...
	<br>
	<label>Estatus:</label>
	<input type="text" name="estatus" placeholder="Estatus" required="required" class="form-control" value="">
	<br>
	...
	<input type="number" name="exist" placeholder="Existencia" required="required" class="form-control" value="">
	<br>
	<label>Imagen:</label>
